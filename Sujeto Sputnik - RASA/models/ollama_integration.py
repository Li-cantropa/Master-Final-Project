...
class LlamaIntegration:
    ...
    def list_available_models(self) -> List[str]:
        """
        Obtiene una lista de los modelos disponibles en Ollama y devuelve una lista de nombres de modelos.
        Aunque no lo estemos utilizando para este proyecto, es útil si, en un futuro, se quisiera cambiar a 
        otro modelo para probar otro tipo de respuestas o funcionalidades.
        """
        try:
